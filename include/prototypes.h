...
/* in file ramRead.c */
extern	devcall	ramRead(struct dentry *, void *, uint32);

/* in file ramWrite.c */
extern	devcall	ramWrite(struct dentry *, void *, uint32);

/* in file ramsInit.c */
extern	devcall	ramsInit(struct dentry *);

/* in file ramsClose.c */
extern	devcall	ramsClose(struct dentry *);

/* in file ramsRead.c */
extern	devcall	ramsRead(struct dentry *, void *, uint32);

/* in file ramsWrite.c */
extern	devcall	ramsWrite(struct dentry *, void *, uint32);
